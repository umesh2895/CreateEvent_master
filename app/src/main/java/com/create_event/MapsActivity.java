...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchArea = (TextView) findViewById(R.id.search_area);
        ...
        //set text to toolbar
        getSupportActionBar().setTitle("Set Event Location");
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnCameraChangeListener(new GoogleMap.OnCameraChangeListener() {
            ...
            public void onCameraChange(CameraPosition cameraPosition) {
                ...
                try {
                    ...
                    mLocationMarkerText.setText("Set this location for event");
        ...
        //setting onclick listener to "set this location"
        mLocationMarkerText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent output = new Intent();
                output.putExtra("event_address", mLocationAddress.getText().toString());
                setResult(MapsActivity.RESULT_OK, output);
                finish();
                //Toast.makeText(getApplicationContext(),"Lat= "+mLocation.getLatitude()+"\nLong="+mLocation.getLongitude(),Toast.LENGTH_SHORT ).show();
            }
        });
    }
